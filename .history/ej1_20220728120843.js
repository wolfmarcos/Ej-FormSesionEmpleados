...
const teta=/\w/
    ...
    if (nombre.lenght > 20) {alert("NO")}else
    if (nombre.lenght < 3) {alert("NO")}else
    if (nombre.test(".")) {alert("NO")}else
    if (nombre.content == "/") {alert("NO")}else
    if (sieldo.lenght > 3) {alert("NO")}else
    if (isNaN(sueldo)) {alert("NO")}else
