...
let i = 0;
let repeticion = true;
resu = document.querySelector(".contenedorR2").parentElement
...
valdarCampos=()=>{
    ...
    if (nombre)
    {formNul(nombre,"imcompleto")} 
     else{formOk(nombre)}
    if (sueldo) { formNul(sueldo,"imcompleto2")} else{if (isNaN(sueldo)){formNul(sueldo,"no es numero")}}
