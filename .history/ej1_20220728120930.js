...
const teta=/\w/
    ...
    if (nombre.lenght > 20) {alert("NO")}else{     error=1}
    if (nombre.lenght < 3) {alert("NO")}else{     error=1}
    if (nombre.test(".")) {alert("NO")}else{     error=1}
    if (nombre.content == "/") {alert("NO")}else{     error=1}
    if (sieldo.lenght > 3) {alert("NO")}else{     error=1}
    if (isNaN(sueldo)) {alert("NO")}else{     error=1}
