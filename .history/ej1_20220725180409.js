...
let i= 0;
let repeticion = true;
resu=querySelector(".contenedorR")
...
for (n in emas300){ resud+=´<div class=" resu">´${emas300.sueldo} </div><div class=" resu">´${emas300.sueldo} </div>´}
     
}
resu.tex=´<div class=" resu">nomebre </div><div class=" resu"> sueldo </div>´
