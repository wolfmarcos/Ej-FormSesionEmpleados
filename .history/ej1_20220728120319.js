...
const teta=/\w/
    ...
    if (nombre.lenght > 20) {alert("NO")}
    if (nombre.lenght < 3) {alert("NO")}
    if (nombre.test(".")) {alert("NO")}
    if (nombre.content == "/") {alert("NO")}
    if (sieldo.lenght > 3) {alert("NO")}
    if (isNaN(sueldo)) {alert("NO")}
}
valdarCampos=()=>{
    ...
    if (nombre = "") {alert("NO")}else{validarf()}
