...
document.querySelector(".fa-xmark").addEventListener("click", (e) => {let mas=document.querySelector("main").classList.toggle("nv");}
document.querySelector("#empleadosMas300").addEventListener("click", (e) => {
    ...
    try {
        ...
        let mas=document.querySelector("main").classList.toggle("nv");
