...
valdarCampos=()=>{
    ...
    { formNul(nombres,"llene los campos")} 
     else{  declaracion=formOk(formNul())}
...
formOk = (inputs) => {
    // const teta=/\w/
        if (inputs.lenght < 20) {formNul(declaracion=inputs,"menos de 20 caracteres")}
        if (inputs.lenght > 3) {formNul(declaracion=inputs,"mas de 3 caracteres")}
