...
formOk = (inputs) => {
    // const teta=/\w/
        ...
        if (!/[a-z]/.test(inputs.value)) {console.log("es:"+!/\w/.test(inputs.value));declaracion=formNul(inputs,"solo letra ")}
...
document.getElementById("form").addEventListener("submit", (e) => {
    ...
    console.log("final  :"valdarCampos(nombre,sueldo))
   if(valdarCampos(nombre,sueldo)){
