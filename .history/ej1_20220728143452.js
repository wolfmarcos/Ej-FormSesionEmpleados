...
formOk = (inputs) => {
    ...
    // const teta=/\w/
        ...
        if (unDato.lenght > 20) {alert("NO1")}else{   alert("NO11")  errors=1}
        if (unDato.lenght < 3) {alert("NO2")}else{  alert("NO22")   errors=1}
        // if (nombre.test(".")) {alert("NO")}else{     error=1}
        if (/\w/.test(unDato)) {alert("NO/w/" + inputs) }else{     errors=1}
