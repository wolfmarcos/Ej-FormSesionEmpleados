...
//  recuerde cargar los datos como  un nuevo objeto. Además el programa deberá informar el importe que gasta la empresa en sueldos total del al personal.
let aprobados = 0;
let i= 0;
let repeticion = true;
...
for (n of emas300){ 
    ...
    //   resud+= `<div>${n.nomebres}</div>  <div>${n.sueldos}</div>/div>`
console.log(resud)
