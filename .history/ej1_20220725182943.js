...
document.querySelector("#agregarHTML").addEventListener("click", (e) => {
    ...
    while(repeticion == true){
        ...
        this.empleados[i]={nomebres:nombre,sueldos:sueldo,id:(i+"pepito") } 
        i = i + 1;
 ...
 console.log(empleados.sueldoaaaaaaaaaaaaaaaaaaaaa)
...
console.log(emas300)
for (n in emas300){ 
  this.resud+='<div class=" resu">'+ emas300.sueldo +'</div><div class=" resu">'+emas300.sueldo+ '</div>'}
})   
