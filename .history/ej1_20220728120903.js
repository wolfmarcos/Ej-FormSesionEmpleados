...
validarF = (nombre, sueldo) => {
nota= Element.querySelector(".nota")


const teta=/\w/
   
    if (nombre.lenght > 20) {alert("NO")}else{     error=}
    if (nombre.lenght < 3) {alert("NO")}else{     error=}
    if (nombre.test(".")) {alert("NO")}else{     error=}
    if (nombre.content == "/") {alert("NO")}else{     error=}
    if (sieldo.lenght > 3) {alert("NO")}else{     error=}
    if (isNaN(sueldo)) {alert("NO")}else{     error=}
...
valdarCampos=()=>{
    ...
    if (nombre = "") {alert("NO")}else{validarf(n)}
    if (nombre = "") {alert("NO")}else{validarf(n)}
