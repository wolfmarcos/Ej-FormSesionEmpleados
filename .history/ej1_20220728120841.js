...
const teta=/\w/
    ...
    if (nombre.lenght > 20) {alert("NO")}e
    if (nombre.lenght < 3) {alert("NO")}e
    if (nombre.test(".")) {alert("NO")}e
    if (nombre.content == "/") {alert("NO")}e
    if (sieldo.lenght > 3) {alert("NO")}e
    if (isNaN(sueldo)) {alert("NO")}e
