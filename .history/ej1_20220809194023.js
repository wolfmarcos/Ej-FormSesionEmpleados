...
let imgaimgaimgaimgaimgaimgaimgaimga=document.querySelector("url-animada")
let hijosTotal = total.children;

const BucleColores = (i) => {  
    return new Promise((p)=>{setInterval(() => p(hijosTotal[i].classList.toggle("a")), 900) }) }
